...
if(!empty($list))
{
	...
	echo "<tr class='header'><td>&nbsp;</td><td>Teacher</td><td>Period</td><td>MPS Payroll Number</td><td>Teaching Subject</td><td>Average Workload</td><td>Training</td><td>Responsibilities</td><td>Last Updated</td></tr>";
