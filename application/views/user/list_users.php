...
<!-- Javascript -->
<?php echo minify_js('user-list_users', array('jquery-2.1.1.min.js', 'jquery-ui.js', 'jquery.form.js', 'tmis.js', 'tmis.fileform.js', 'tmis.menu.js', 'tmis.responsive.js', 'tmis.list.js', 'tmis.shadowbox.js', 'tmis.pagination.js', 'tmis.search.js'));?>
</head>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
      		<tr>
              <td><div class="h1 grey nowrap listheader">Users<?php if(check_access($this, 'add_new_user', 'boolean')) echo "<div class='nextdiv addcontenticon' data-url='user/add' title='Click to add'></div>";?><?php if(check_access($this, 'view_users', 'boolean') && !empty($list)) echo "<div class='nextdiv downloadcontenticon' style='margin-left:5px;' data-url='user/download' title='Click to download'></div>";?></div><div class="listsearchfield"><input type="text" id="usersearch__users" data-type="user" name="usersearch__users" placeholder="Search Users" class="findfield" value=""/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><div id="paginationdiv__usersearch_list">
    <div id="usersearch__1"><?php $this->load->view('user/list', array(
	'listid'=>'usersearch',
